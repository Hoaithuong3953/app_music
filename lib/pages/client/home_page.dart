...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarImgURL = userProvider.user?.avatarImgURL;
                  ...
                  child: Row(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: avatarImgURL != null ? NetworkImage(avatarImgURL) : null,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.of(context).pushNamed('/all-songs');
                          },
                          child: Text(
                            'View All',
